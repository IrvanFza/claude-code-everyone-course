...
description: 'Learn the "Ask User Question" technique, the 50% context rule, and more from Greg Isenberg interview with Ross Mike. Runs free in Claude Code.'
...
<CopyPromptBlock prompt={`Help me install fullstackpm.com/cli and start Ross & Mike Workflows`} />
