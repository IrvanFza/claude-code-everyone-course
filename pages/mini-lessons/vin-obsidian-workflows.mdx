...
<img src="/images/og-vin-obsidian.png" alt="The Obsidian + Claude Code System — overview of vault infrastructure, custom commands, thinking tools, the golden rule, and the feedback flywheel" style={{width: '100%', borderRadius: '8px', marginBottom: '24px'}} />
...
This lesson runs in the Claude Desktop app. Open Claude, start a new project, and paste this prompt:
...
<CopyPromptBlock prompt={`Help me install fullstackpm.com/cli and start Vin's Obsidian Workflows`} />

Once the lesson materials are installed, type **`/start-lesson`**.

> **Prefer the terminal?** Open Claude Code in a new folder and paste the same prompt. See the [Claude Code CLI guide](/getting-started/claude-code-cli) for setup help.
...
**Get the lesson:** scroll up to [Get Started](#get-started) - one pasted prompt installs everything.
