---
title: 'CLAUDE.md: What It Is, Template & Best Practices (Plain English)'
description: 'CLAUDE.md is Claude Code''s project memory. What to put in it (and what to leave out), a copy-paste template, real examples, and the official-docs details in plain English.'
keywords: 'claude.md best practices, claude.md template, claude.md examples, claude code memory, claude.md tutorial, claude code project memory, claude code context, what is claude.md'
---
...
- [Every Claude Code Concept in Plain English](/guides/claude-code-concepts-explained) - How CLAUDE.md fits alongside skills, agents, and MCP
