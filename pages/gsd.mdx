...
<CopyPromptBlock prompt={`Help me install fullstackpm.com/cli and start GSD Framework`} />

Once the lesson materials are installed, type **`/start-3-1`**.

Prefer the terminal? Open Claude Code in a new folder and paste the same prompt.
