...
- **Runs in the Claude Desktop app** - this course uses the Code tab; a [terminal version](/getting-started/claude-code-cli) exists too
- **Nothing to memorize** - you just have conversations
...
- The app is just where you have conversations
